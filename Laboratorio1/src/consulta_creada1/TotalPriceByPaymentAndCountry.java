...
*/
public class TotalPriceByPaymentAndCountry {
    public static void main(String[] args) {
        ...
        job_conf.setMapperClass(TotalPriceByPaymentAndCountryMapper.class);
        job_conf.setReducerClass(TotalPriceByPaymentAndCountryReducer.class);
