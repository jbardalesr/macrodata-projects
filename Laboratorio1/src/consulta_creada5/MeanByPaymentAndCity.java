...
public class MeanByPaymentAndCity {
    public static void main(String[] args) {
        JobClient my_client1 = new JobClient();
        // Create a configuration object for the job
        JobConf job_conf1 = new JobConf(MeanByPaymentAndCity.class);
        ...
        job_conf1.setMapperClass(MeanByPaymentAndCityMapper.class);
        job_conf1.setReducerClass(MeanByPaymentAndCityReducer.class);
        ...
        JobConf job_conf2 = new JobConf(MeanByPaymentAndCity.class);
