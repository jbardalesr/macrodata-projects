...
public class ProductByDayAndCountry {
    public static void main(String[] args) {
        JobClient my_client1 = new JobClient();
        // Create a configuration object for the job
        JobConf job_conf1 = new JobConf(ProductByDayAndCountry.class);
        ...
        job_conf1.setMapperClass(ProductByDayAndCountryMapper.class);
        job_conf1.setReducerClass(ProductByDayAndCountryReducer.class);
        ...
        JobConf job_conf2 = new JobConf(ProductByDayAndCountry.class);
