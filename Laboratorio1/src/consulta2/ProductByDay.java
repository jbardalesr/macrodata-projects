...
public class ProductByDay {
    public static void main(String[] args) {
        JobClient my_client = new JobClient();
        // Create a configuration object for the job
        JobConf job_conf = new JobConf(ProductByYear.class);
        ...
        job_conf.setMapperClass(ProductByDayMapper.class);
        job_conf.setReducerClass(ProductByDayReducer.class);
