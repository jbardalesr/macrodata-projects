...
// estimator
val classifier = new RandomForestClassifier().setImpurity("gini").setMaxDepth(10).setNumTrees(70).setFeatureSubsetStrategy("auto").setSeed(1234567).setMinInfoGain(0.001)
// pipeline
...
// GUARDAR EL MODELO
model.write.overwrite().save("./tmp/rf-model")
